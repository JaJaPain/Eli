...
function draw() {
    ...
    // --- Enhanced Morph/Transition Logic ---
    ...
    // 3. The House (MORPHING LAYER)
    push();
    // Dynamic Y-offset: The last house (rubble) needs to sit lower (+30) 
    // whereas the standing houses sit at +10
    let currentY = (houseIndex === 3) ? 30 : 10;
    let nextY = (nextHouseIndex === 3) ? 30 : 10;
    
    // Interpolate Y during morphing
